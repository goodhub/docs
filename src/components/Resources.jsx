...
function ResourcePattern({ mouseX, mouseY, ...gridProps }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#d7e2ed] to-[#dfe8fb] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#20272e] dark:to-[#282e34]"
        style={style}
      />
      <motion.div
